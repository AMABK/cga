...
const API_BASE = environment.apiUrl + 'message-templates';
...
export class MessageTemplateService {
  ...
  findByTemplateName(TemplateName: any): Observable<any[]> {
    return this.http.get<any[]>(`${API_BASE}?TemplateName=${TemplateName}`,httpOptions);
  }
}
