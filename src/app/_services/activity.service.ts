...
export class ActivityService {
  ...
  getAll(): Observable<any[]> {
	let filter = { include: [{ relation: "ServiceCategory" }] };
  ...
  findByActivityName(ActivityName: any): Observable<any[]> {
    return this.http.get<any[]>(`${API_BASE}?ActivityName=${ActivityName}`,httpOptions);
  }
}
