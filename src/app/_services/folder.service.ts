...
const API_BASE = environment.apiUrl + 'folders';
...
export class FolderService {
  ...
  findByFolderName(FolderName: any): Observable<any[]> {
    return this.http.get<any[]>(`${API_BASE}?FolderName=${FolderName}`,httpOptions);
  }
}
