...
export class BusinessCategoriesComponent implements OnInit {
  ...
  pk: string = 'BusinessCategoryID';
  title: string;
  object: string = 'Business Category';
  parentUrl: string = '/settings/business-categories';
  editUrl: string = '/settings/business-categories/';
  form: FormGroup;
  id: string;
  isAddMode: boolean;
  ...
  constructor(
    ...
    private dataService: BusinessCategoryService,
