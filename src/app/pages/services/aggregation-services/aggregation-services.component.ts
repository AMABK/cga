...
export class AggregationServicesComponent implements OnInit {
  pk: string = 'ServiceID';
  title: string = 'Aggregation Services';
  object: string = 'Service';
  editUrl: string = 'services/aggregation-edit/';
  addUrl: string = 'services/aggregation-add';
  rows: any[];
  ...
  constructor(private dataService: AggregationService,
