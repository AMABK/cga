...
@Component({
  selector: 'app-space-categories',
  templateUrl: './space-categories.component.html',
  styleUrls: ['./space-categories.component.css']
})
export class SpaceCategoriesComponent implements OnInit {

  pk: string = 'SpaceCategoryID';
  title: string;
  object: string = 'Space Category';
  parentUrl: string = '/settings/space-categories';
  editUrl: string = '/settings/space-categories/';
  form: FormGroup;
  id: string;
  isAddMode: boolean;
  ...
  constructor(public __elementSelectionService:ElementSelectionService, private __componentInspectorService:ComponentInspectorService,
    ...
    private dataService: SpaceCategoryService,
