...
@Component({
  selector: 'app-input-services',
  templateUrl: './input-services.component.html',
  styleUrls: ['./input-services.component.css']
})
export class InputServicesComponent implements OnInit {
  pk: string = 'ServiceID';
  title: string = 'Input & PHHs Service';
  object: string = 'Service';
  editUrl: string = 'services/inputs-edit/';
  addUrl: string = 'services/inputs-add';
  rows: any[];
