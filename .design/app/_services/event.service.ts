...
const API_BASE = environment.apiUrl + 'events';
...
export class EventService {
  ...
  findByEventTitle(EventTitle: any): Observable<any[]> {
    return this.http.get<any[]>(`${API_BASE}?EventTitle=${EventTitle}`,httpOptions);
  }
}
